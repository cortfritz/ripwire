...
// Elixir joins them, and unambiguously: `#` is its ONLY comment opener — there is no block-comment form
// and no other meaning for the character outside a string, sigil or `?#` char literal, all of which the
// scanner already reads as single tokens.
