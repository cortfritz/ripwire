...
constexpr std::uint32_t kIngestParserVerMirror    = 79;   // MUST equal ingest.cpp's kParserVer   (gated)
                                                          // 78 = 2026-09-06 (Elixir tier): vendored tree-sitter-elixir,
                                                          // queries/elixir/tags.scm, .ex/.exs. See ingest_cache.h.
